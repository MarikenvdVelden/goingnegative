...
```{r "Table with Descriptives", echo=F, message=FALSE, warning=FALSE, fig.width=10, fig.height=10}
df <- d %>%
  ...
  mutate(ie3 = ifelse(party == "FvD", 0, ie3),
...
render_j2("src/data-processing/table_descriptives.tex.j2", "report/figures/table_descriptives.tex", data=list(data=table, methods=methodnames))
```
